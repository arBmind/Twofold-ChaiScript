...
# ChaiScript {
DEFINES *= CHAISCRIPT_NO_THREADS
isEmpty(CHAISCRIPT_INCLUDES) {
    CHAISCRIPT_INCLUDES = $$PROJECT_ROOT/vendor/ChaiScript/include
#    !isEmpty(INSTALL_HEADERS_PREFIX): CHAISCRIPT_INCLUDES = $$INSTALL_HEADERS_PREFIX
}
#isEmpty(CHAISCRIPT_LIB) {
#    CHAISCRIPT_LIB = $$LIB_VENDOR
#    !isEmpty(INSTALL_PREFIX): CHAISCRIPT_LIB = $$INSTALL_PREFIX
#}
INCLUDEPATH *= $$CHAISCRIPT_INCLUDES
#LIBS *= -L$$CHAISCRIPT_LIB
#LIBS *= -lChaiScript
#DEPENDPATH *= $$CHAISCRIPT_LIB

#win32:!win32-g++:PRE_TARGETDEPS += $$CHAISCRIPT_LIB/ChaiScript.lib
#else: PRE_TARGETDEPS += $$CHAISCRIPT_LIB/libChaiScript.a
# }
